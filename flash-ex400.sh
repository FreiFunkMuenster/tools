...
#Base stolen from here: https://github.com/herbetom/multiflash/blob/main/install-ex400.sh
...
FACTORY_FILENAME="openwrt-24.10.1-ramips-mt7621-genexis_pulse-ex400-factory.bin"

SYSUPGRADE_FILENAME="gluon-ffmsl-v2023.2.5+10.2.0-genexis-pulse-ex400-sysupgrade.bin"


if [ ! -f "$FACTORY_FILENAME" ]; then
	echo "${FACTORY_FILENAME} doesn't exist."
	wget "https://downloads.openwrt.org/releases/24.10.1/targets/ramips/mt7621/openwrt-24.10.1-ramips-mt7621-genexis_pulse-ex400-factory.bin"
fi

if [ ! -f "$SYSUPGRADE_FILENAME" ]; then
	echo "$SYSUPGRADE_FILENAME doesn't exist."
	wget "https://firmware.ffmsl.de/multidomain/versions/v10.2.0/sysupgrade/gluon-ffmsl-v2023.2.5%2B10.2.0-genexis-pulse-ex400-sysupgrade.bin"
fi
